  ...
  return (
        ...
        <div className="container-fluid mt-20 py-15">
            ...
            <div className="max-w-7xl mt-10 mx-auto ">
                ...
                <iframe
                    className="absolute top-0 left-0 w-full h-full rounded-lg"
                    src="https://youtube.com/embed/QVUSv56Rpbo?si=Fy4fhkckFftYd5Dy"
                    title="YouTube video"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                ...
                <iframe
                    className="absolute top-0 left-0 w-full h-full rounded-lg"
                    src="https://youtube.com/embed/78P2b5Cth6w?si=Zg0dzQBMwW0L4ie4"
                    title="YouTube video"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                ...
                <iframe
                    className="absolute top-0 left-0 w-full h-full rounded-lg"
                    src="https://www.youtube.com/embed/GDBKNiAb9Rk"
                    title="YouTube video"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                ...
                <iframe
                    className="absolute top-0 left-0 w-full h-full rounded-lg"
                    src="https://www.youtube.com/embed/ilQ2O1-W9TY"
                    title="YouTube video"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                ...
                <iframe
                    className="absolute top-0 left-0 w-full h-full rounded-lg"
                    src="https://www.youtube.com/embed/px3_Ei_I9Gg"
                    title="YouTube video"
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
